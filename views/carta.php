            ...
            <div class="cuadrado1">
                    ...
                    <?php foreach ($mariscadas as $producto){ ?>
                        <div class="col-5 cuadradoProducto">
                            <div class="cuadradoImg">  
                                <img src="/p2/<?= $producto->getImagen()?>" alt="Imagenes de las mariscadas">
                            </div>
                ...
                <div class="row cuadrado2">
                    <?php foreach ($pescados as $producto){ ?>
                        <div class="col-5 cuadradoProducto"> 
                            <div class="cuadradoImg">  
                                <img src="/p2/<?= $producto->getImagen()?>" alt="Imagenes de los pescdos">
                            </div>
                ...
                <div class="row cuadrado2">
                    <?php foreach ($mariscos as $producto){ ?>
                        <div class="col-5 cuadradoProducto"> 
                            <div class="cuadradoImg">  
                                <img src="/p2/<?= $producto->getImagen()?>" alt="Imagenes de los mariscos">
                            </div>
                ...
                <div class="row cuadrado2">
                    <?php foreach ($cefalopodos as $producto){ ?>
                        <div class="col-5 cuadradoProducto"> 
                            <div class="cuadradoImg">  
                                <img src="/p2/<?= $producto->getImagen()?>" alt="Imagenes de los cefalopodos">
                            </div>
                ...
                <div class="row cuadrado2">
                    <?php foreach ($moluscos as $producto){ ?>
                        <div class="col-5 cuadradoProducto" > 
                            <div class="cuadradoImg">  
                                <img src="/p2/<?= $producto->getImagen()?>" alt="Imagenes de los moluscos">
                            </div>
